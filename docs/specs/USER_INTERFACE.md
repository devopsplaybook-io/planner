...
- [x] A shared comment thread component renders the comments of tasks and of notes the same way: markdown bodies clipped to two lines, softened by a fade and completed by a "Show more"/"Show less" disclosure when they are longer, edit and delete actions revealed on hover for the comment author and admins, and an add-comment form
