...
| [x] Notification time | Reminders are sent from a configured hour of the day onwards (server local time, default 9:00)                                          |
| [x] No duplicates    | Each reminder is sent at most once per task, due date, and reminder kind                                                                 |
...
_Implementation: [x]=Done [~]=Partial [ ]=Not Started | Last spec review: 2026-08-19_
